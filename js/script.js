	...
	*/
	...
	function enableMobileNav(){
		...
		$('#menu-button').click(function(){
			...
			if(!$('.menu-principal-navigation').hasClass('navigation-opened')){

				$('.menu-principal-navigation').slideDown(200).addClass('navigation-opened');

			}else{

				$('.menu-principal-navigation').slideUp(200).removeClass('navigation-opened');
		...
		$(window).resize(function(){
			...
			if(window_w > 991){
				...
				$('.menu-principal-navigation').show().attr('style','').removeClass('navigation-opened');
		...
		/* Dropdowns */
		$('.menu-principal-navigation li').each(function(){
		...
		$('.menu-principal-navigation .dropdown-button').click(function(){

			$(this).parent().toggleClass('dropdown-opened').find('>ul').slideToggle(100);
